...
const DEMO_ENTRIES = [
  { id: 'demo-1', timestamp: '2026-06-16T08:00:00Z', input: { dayOfWeek: 'Monday', scheduledMenu: 'Pepperoni pizza with side salad', expectedAttendance: 520, weatherCondition: 'Sunny', temperature: 78 }, result: { predictedWasteKg: 42.3, actionableInterventions: ['Reduce pizza production by 15% on Mondays', 'Pre-slice pizzas to control portions', 'Offer salad-only option for lighter eaters'], riskWarning: 'Benchmark predictions — actual results may vary by ±35% depending on local student preferences and seasonal factors. Validate against manual measurements before making procurement changes.', humanInTheLoopAction: 'Review Monday production numbers with kitchen staff before adjusting supplier orders. Consider a 2-week trial of reduced pizza orders.', metadata: { modelUsed: 'meta-llama/Llama-3.1-8B-Instruct:fastest', latencyMs: 847, processedAt: '2026-06-16T08:00:00Z', inputSnapshot: { dayOfWeek: 'Monday', scheduledMenu: 'Pepperoni pizza with side salad', expectedAttendance: 520, weatherCondition: 'Sunny', temperature: 78 } } } },
  { id: 'demo-2', timestamp: '2026-06-15T12:15:00Z', input: { dayOfWeek: 'Tuesday', scheduledMenu: 'Beef tacos with rice and beans', expectedAttendance: 410, weatherCondition: 'Cloudy', temperature: 65 }, result: { predictedWasteKg: 28.7, actionableInterventions: ['Reduce rice portions by 10% — consistently leftover', 'Add a salsa bar to increase taco appeal', 'Offer bean-only option for vegetarian students'], riskWarning: 'Benchmark predictions — actual results may vary by ±35% depending on local student preferences and seasonal factors. Validate against manual measurements before making procurement changes.', humanInTheLoopAction: 'Test reduced rice portions for one week and track waste changes before committing to permanent change.', metadata: { modelUsed: 'meta-llama/Llama-3.1-8B-Instruct:fastest', latencyMs: 723, processedAt: '2026-06-15T12:15:00Z', inputSnapshot: { dayOfWeek: 'Tuesday', scheduledMenu: 'Beef tacos with rice and beans', expectedAttendance: 410, weatherCondition: 'Cloudy', temperature: 65 } } } },
  { id: 'demo-3', timestamp: '2026-06-14T11:45:00Z', input: { dayOfWeek: 'Wednesday', scheduledMenu: 'Grilled chicken with rice and vegetables', expectedAttendance: 380, weatherCondition: 'Rainy', temperature: 58 }, result: { predictedWasteKg: 35.1, actionableInterventions: ['Reduce vegetable portions — broccoli and carrots consistently left behind', 'Add dipping sauce station to increase vegetable consumption', 'Switch to roasted vegetables for better appeal in rainy weather'], riskWarning: 'Benchmark predictions — actual results may vary by ±35% depending on local student preferences and seasonal factors. Validate against manual measurements before making procurement changes.', humanInTheLoopAction: 'Conduct a 1-week taste test of roasted vs steamed vegetables to determine student preference before menu changes.', metadata: { modelUsed: 'meta-llama/Llama-3.1-8B-Instruct:fastest', latencyMs: 691, processedAt: '2026-06-14T11:45:00Z', inputSnapshot: { dayOfWeek: 'Wednesday', scheduledMenu: 'Grilled chicken with rice and vegetables', expectedAttendance: 380, weatherCondition: 'Rainy', temperature: 58 } } } },
  { id: 'demo-4', timestamp: '2026-06-13T10:30:00Z', input: { dayOfWeek: 'Thursday', scheduledMenu: 'Fish filet with mashed potatoes', expectedAttendance: 290, weatherCondition: 'Windy', temperature: 62 }, result: { predictedWasteKg: 51.2, actionableInterventions: ['Fish filet has lowest consumption rate — consider alternating with chicken tenders', 'Reduce fish order by 30% on Thursdays', 'Offer mac and cheese as alternative entree'], riskWarning: 'Benchmark predictions — actual results may vary by ±35% depending on local student preferences and seasonal factors. Validate against manual measurements before making procurement changes.', humanInTheLoopAction: 'Survey students on fish vs chicken preference. Trial a 50/50 split for 2 weeks and compare waste data.', metadata: { modelUsed: 'meta-llama/Llama-3.1-8B-Instruct:fastest', latencyMs: 756, processedAt: '2026-06-13T10:30:00Z', inputSnapshot: { dayOfWeek: 'Thursday', scheduledMenu: 'Fish filet with mashed potatoes', expectedAttendance: 290, weatherCondition: 'Windy', temperature: 62 } } } },
  { id: 'demo-5', timestamp: '2026-06-12T09:20:00Z', input: { dayOfWeek: 'Friday', scheduledMenu: 'Chicken tenders with french fries', expectedAttendance: 650, weatherCondition: 'Sunny', temperature: 85 }, result: { predictedWasteKg: 18.4, actionableInterventions: ['Popular menu — maintain current production levels', 'Consider adding a fruit cup option to improve nutrition', 'Monitor closely — high attendance days amplify any waste inefficiency'], riskWarning: 'Benchmark predictions — actual results may vary by ±35% depending on local student preferences and seasonal factors. Validate against manual measurements before making procurement changes.', humanInTheLoopAction: 'No action required at this time. Continue monitoring Friday production and track any attendance trends.', metadata: { modelUsed: 'meta-llama/Llama-3.1-8B-Instruct:fastest', latencyMs: 812, processedAt: '2026-06-12T09:20:00Z', inputSnapshot: { dayOfWeek: 'Friday', scheduledMenu: 'Chicken tenders with french fries', expectedAttendance: 650, weatherCondition: 'Sunny', temperature: 85 } } } },
  { id: 'demo-6', timestamp: '2026-06-11T14:00:00Z', input: { dayOfWeek: 'Wednesday', scheduledMenu: 'Spaghetti with marinara and garlic bread', expectedAttendance: 445, weatherCondition: 'Cloudy', temperature: 70 }, result: { predictedWasteKg: 31.9, actionableInterventions: ['Garlic bread consistently overproduced — cut by 20%', 'Offer half-portion spaghetti option for smaller appetites', 'Add a side salad option to improve meal balance'], riskWarning: 'Benchmark predictions — actual results may vary by ±35% depending on local student preferences and seasonal factors. Validate against manual measurements before making procurement changes.', humanInTheLoopAction: 'Trial reduced garlic bread production for 1 week. Track waste difference and student feedback.', metadata: { modelUsed: 'meta-llama/Llama-3.1-8B-Instruct:fastest', latencyMs: 734, processedAt: '2026-06-11T14:00:00Z', inputSnapshot: { dayOfWeek: 'Wednesday', scheduledMenu: 'Spaghetti with marinara and garlic bread', expectedAttendance: 445, weatherCondition: 'Cloudy', temperature: 70 } } } },
  { id: 'demo-7', timestamp: '2026-06-10T08:45:00Z', input: { dayOfWeek: 'Tuesday', scheduledMenu: 'Fresh salad bar with grilled chicken', expectedAttendance: 310, weatherCondition: 'Sunny', temperature: 82 }, result: { predictedWasteKg: 22.6, actionableInterventions: ['Salad bar items have even consumption — maintain current setup', 'Add seasonal fruits to keep the bar fresh and appealing', 'Consider pre-boxed salads for faster service'], riskWarning: 'Benchmark predictions — actual results may vary by ±35% depending on local student preferences and seasonal factors. Validate against manual measurements before making procurement changes.', humanInTheLoopAction: 'No immediate changes needed. Monitor salad bar waste weekly as seasons change.', metadata: { modelUsed: 'meta-llama/Llama-3.1-8B-Instruct:fastest', latencyMs: 689, processedAt: '2026-06-10T08:45:00Z', inputSnapshot: { dayOfWeek: 'Tuesday', scheduledMenu: 'Fresh salad bar with grilled chicken', expectedAttendance: 310, weatherCondition: 'Sunny', temperature: 82 } } } },
  { id: 'demo-8', timestamp: '2026-06-09T11:30:00Z', input: { dayOfWeek: 'Thursday', scheduledMenu: 'Mac and cheese with broccoli', expectedAttendance: 495, weatherCondition: 'Rainy', temperature: 55 }, result: { predictedWasteKg: 26.3, actionableInterventions: ['Mac and cheese is popular — maintain portions', 'Broccoli waste is moderate — offer broccoli-cheese blend for better acceptance', 'Rainy days see higher comfort food consumption — slight production increase warranted'], riskWarning: 'Benchmark predictions — actual results may vary by ±35% depending on local student preferences and seasonal factors. Validate against manual measurements before making procurement changes.', humanInTheLoopAction: 'Test broccoli-cheese blend for 2 weeks and compare waste with current steamed broccoli.', metadata: { modelUsed: 'meta-llama/Llama-3.1-8B-Instruct:fastest', latencyMs: 778, processedAt: '2026-06-09T11:30:00Z', inputSnapshot: { dayOfWeek: 'Thursday', scheduledMenu: 'Mac and cheese with broccoli', expectedAttendance: 495, weatherCondition: 'Rainy', temperature: 55 } } } },
];
